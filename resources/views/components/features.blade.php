                ...
                <nav class="grid gap-4 mt-5 md:mt-10" aria-label="Tabs" role="tablist">
                    <button type="button"
                        ...
                        <span class="flex">
                            ...
                            <span class="grow ms-6">
                                <span
                                    class="block text-lg font-semibold hs-tab-active:text-blue-600 text-gray-800 dark:hs-tab-active:text-blue-500 dark:text-gray-200">Доставка</span>
                                <span
                    ...
                    <button type="button"
                        ...
                        <span class="flex">
                            ...
                            <span class="grow ms-6">
                                <span
                                    class="block text-lg font-semibold hs-tab-active:text-blue-600 text-gray-800 dark:hs-tab-active:text-blue-500 dark:text-gray-200">Оплата</span>
                                <span
                                    class="block mt-1 text-gray-800 dark:hs-tab-active:text-gray-200 dark:text-gray-200">Предоставляем
                                    отсрочку/рассрочку платежа по договору</span>
                            </span>
                        </span>
                    </button>
                    ...
                    <button type="button"
                        ...
                        <span class="flex">
                            ...
                            <span class="grow ms-6">
                                <span
                                    class="block text-lg font-semibold hs-tab-active:text-blue-600 text-gray-800 dark:hs-tab-active:text-blue-500 dark:text-gray-200">Гособоронзаказ</span>
                                <span
                                    class="block mt-1 text-gray-800 dark:hs-tab-active:text-gray-200 dark:text-gray-200">Работаем
                                    по ФЗ-№275 от 01.07.2015г. о Гособоронзаказе</span>
                            </span>
                        </span>
                    </button>
                </nav>
