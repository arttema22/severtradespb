...
@section('content')
<x-moonshine::grid class="mb-6">
    <x-moonshine::column colSpan="3">
    ...
    <x-moonshine::column colSpan="5">
        ...
        <div>Категория
            ...
            <x-moonshine::link-button :href="route('categories.index', $category->slug)" {{-- :filled="true" --}}>
                {{$category->name}}
        ...
        <div>Теги
            ...
            <x-moonshine::link-button :href="route('tags.index', $tag->slug)" {{-- :filled="true" --}}>
                {{$tag->name}}
            </x-moonshine::link-button>
            @endforeach
        </div>
...
<x-moonshine::grid>
    <x-moonshine::column colSpan="4">
        <x-moonshine::box title="Гособоронзаказ">
            Работаем по ФЗ-№275 от 01.07.2015г. о Гособоронзаказе
        </x-moonshine::box>
    </x-moonshine::column>
    <x-moonshine::column colSpan="4">
